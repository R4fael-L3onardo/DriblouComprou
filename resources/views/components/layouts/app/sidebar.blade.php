    ...
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist.group
            ...
            <flux:navlist.item
                ...
                <flux:navlist variant="outline">
                    <flux:navlist.item icon="user" href="https://github.com/fernandozanela" target="_blank">
                        {{ __('GitHub Fernando') }}
                    </flux:navlist.item>

                    <flux:navlist.item icon="user" href="https://github.com/R4fael-L3onardo" target="_blank">
                        {{ __('GitHub Rafael') }}
                    </flux:navlist.item>

                    <flux:navlist.item icon="code-bracket-square" href="https://github.com/R4fael-L3onardo/DriblouComprou" target="_blank">
                        {{ __('Repositorio do Projeto') }}
                    </flux:navlist.item>
                </flux:navlist>
